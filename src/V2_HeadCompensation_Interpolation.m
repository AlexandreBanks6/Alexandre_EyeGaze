...
function [mean_accuracies,total_results]=evalModelsRegressComp(data_mat,model_cell,dist_cell,avg_corners,PG_Estimation_Models,max_compensation_models,poly_functions_array)
    %{
    Inputs:
...
function total_results=evalAccuracyComp(model_cell,reformatted_data,right_headers,left_headers,check_model_right,check_model_left,dist_cell,avg_corners,PG_Estimation_Models,max_compensation_models,poly_functions_array)
   %{
    Inputs:
    reformatted_data:
